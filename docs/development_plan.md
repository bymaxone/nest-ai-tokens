...
- **Overall progress:** 🔄 4 / 5 phases done (80%) — 47 / 47 sub-steps (Phase 5 tasks complete; awaiting PR merge)
...
| 5 | [Release v0.1.0](./tasks/phase-05-release.md) | 🔄 In Progress | 7/7 | LOW | 2026-07-04 |
| | **Total** | 🔄 **4 / 5 phases** | **47 / 47 sub-steps** | — | — |

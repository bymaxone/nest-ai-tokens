...
- **Overall progress:** 🔄 1 / 5 phases done (20%) — 13 / 47 sub-steps
...
| 2 | [Ledger + Markup + Events + Prisma Store](./tasks/phase-02-ledger-markup-events-prisma.md) | 🔄 In Progress | 2/7 | HIGH | 2026-07-03 |
...
| | **Total** | 🔄 **1 / 5 phases** | **13 / 47 sub-steps** | — | — |

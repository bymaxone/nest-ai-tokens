...
- **Overall progress:** 🔄 4 / 5 phases done (80%) — 46 / 47 sub-steps (Phase 5 release tasks 5.1–5.6 complete; 5.7 example deferred post-publish; awaiting PR merge)
...
| 5 | [Release v0.1.0](./tasks/phase-05-release.md) | 🔄 In Progress | 6/7 | LOW | 2026-07-04 |
| | **Total** | 🔄 **4 / 5 phases** | **46 / 47 sub-steps** | — | — |

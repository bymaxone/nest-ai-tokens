...
- **Overall progress:** 🔄 1 / 5 phases done (20%) — 12 / 47 sub-steps
...
| 2 | [Ledger + Markup + Events + Prisma Store](./tasks/phase-02-ledger-markup-events-prisma.md) | 🔄 In Progress | 1/7 | HIGH | 2026-07-03 |
...
| | **Total** | 🔄 **1 / 5 phases** | **12 / 47 sub-steps** | — | — |
